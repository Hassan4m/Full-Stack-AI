...
df = pd.read_csv(
    "python_repo/week4/work/zameencom-property-data-By-Kaggle-Short.csv",
    delimiter=";",
    parse_dates=[14],
...
second_row8 = df_index_col.loc[
    df_index_col["agency"] == "Gateway Properties", "location":"agency"
]
print("#Combined row and column selection using .loc")
print(second_row8)
print()
...
df.loc[len(df.index)] = [
    3477952,
    82,
    "https://www.zameen.com/Property/lahore_model_town_6_kanal_excellent_house_for_sale_in_model_town-347795-8-12.html",
    "House2",
    2200000002,
    "Model Town2",
    "Lahore2",
...
# display the modified DataFrame after deleting rows
print(
    "Modified DataFrame -  delete page_url ,property_type , location , city , column :"
)
print(df)
...
df.rename(
    mapper={"bedrooms": "bedrooms_Changed", "date_added": "date_added_Changed"},
    axis=1,
    inplace=True,
)
